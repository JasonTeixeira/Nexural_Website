...
import { signInWithOAuth } from '@/lib/auth/client-helpers'
      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              Sign in to your Nexural Trading account
            </CardDescription>
          </CardHeader>
          <CardContent>
