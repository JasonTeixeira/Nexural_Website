    ...
    <footer className="w-full max-w-[1320px] mx-auto px-5 flex flex-col md:flex-row justify-between items-start gap-8 md:gap-0 py-10 md:py-[70px]">
      ...
      <div className="flex flex-col justify-start items-start gap-8 p-4 md:p-8">
        <div className="flex gap-3 items-stretch justify-center">
          <div className="text-center text-foreground text-xl font-semibold leading-4">Nexural Trading</div>
        </div>
        <p className="text-foreground/90 text-sm font-medium leading-[18px] text-left">AI-powered stock analysis</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 p-4 md:p-8 w-full md:w-auto">
        <div className="flex flex-col justify-start items-start gap-3">
          ...
          <div className="flex flex-col justify-end items-start gap-2">
            <a href="/how-it-works" className="text-foreground text-sm font-normal leading-5 hover:underline">
              How It Works
            </a>
            <a href="/indicators" className="text-foreground text-sm font-normal leading-5 hover:underline">
              Indicators
            </a>
        ...
        <div className="flex flex-col justify-start items-start gap-3">
          ...
          <div className="flex flex-col justify-center items-start gap-2">
            <a href="/about" className="text-foreground text-sm font-normal leading-5 hover:underline">
              About us
            </a>
        ...
        <div className="flex flex-col justify-start items-start gap-3">
          ...
          <div className="flex flex-col justify-center items-start gap-2">
            <a href="/legal-disclaimer" className="text-foreground text-sm font-normal leading-5 hover:underline">
              Legal Disclaimer
            </a>
            <a href="/terms" className="text-foreground text-sm font-normal leading-5 hover:underline">
              Terms of Service
            </a>
            <a href="/privacy" className="text-foreground text-sm font-normal leading-5 hover:underline">
              Privacy Policy
            </a>
